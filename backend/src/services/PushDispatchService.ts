...
> = {
  ...
  // Hygiene work is scheduled work, so it rides the maintenance category. The two exceptions
  // are a failed verification and a contamination alert: both mean something unsafe is in
  // play right now, and neither can wait for somebody to notice a badge.
  CLEANING_TASK_ASSIGNED: 'maintenance',
  CLEANING_TASK_DUE: 'maintenance',
  CLEANING_TASK_OVERDUE: 'maintenance',
  CLEANING_TASK_UNASSIGNED: 'maintenance',
  CLEANING_VERIFICATION_REQUIRED: 'maintenance',
  CLEANING_VERIFICATION_FAILED: 'alarm',
  CLEANING_RECLEAN_REQUIRED: 'maintenance',
  CLEANING_CORRECTIVE_ACTION_ASSIGNED: 'maintenance',
  CLEANING_CORRECTIVE_ACTION_OVERDUE: 'maintenance',
  HYGIENE_COMPLIANCE_ALERT: 'alarm',
};
...
const CHANNEL_BY_NOTIFICATION_TYPE: Record<NotificationType, string> = {
  ...
  CLEANING_TASK_ASSIGNED: ORDER_CHANNEL_ID,
  CLEANING_TASK_DUE: ORDER_CHANNEL_ID,
  CLEANING_TASK_OVERDUE: ORDER_CHANNEL_ID,
  CLEANING_TASK_UNASSIGNED: ORDER_CHANNEL_ID,
  CLEANING_VERIFICATION_REQUIRED: ORDER_CHANNEL_ID,
  CLEANING_VERIFICATION_FAILED: ORDER_CHANNEL_ID,
  CLEANING_RECLEAN_REQUIRED: ORDER_CHANNEL_ID,
  CLEANING_CORRECTIVE_ACTION_ASSIGNED: ORDER_CHANNEL_ID,
  CLEANING_CORRECTIVE_ACTION_OVERDUE: ORDER_CHANNEL_ID,
  HYGIENE_COMPLIANCE_ALERT: ORDER_CHANNEL_ID,
};
